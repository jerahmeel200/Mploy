    ...
    <div>
      ...
      <div className="widow-main bg-[#ffffff]  ">
        <div className="max-w-[1240px] mx-auto py-[100px] sm:py-[150px]">
          ...
          {/* <p className="mt-2 text-[#033777]">Updated at May 25th, 2024</p> */}
          <p className=" text-[#033777] mt-3 mb-[40px] font-medium">
            Updated at May 25th, 2024
          </p>
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            Mploy (“we,” “our,” or “us”) is committed to protecting your
            privacy. This Privacy Policy explains how your personal information
            is collected, used, and disclosed by Mploy.
          </p>
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            Mploy. By accessing or using our Service, you signify that you have
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            <ol className="pl-[20px] sm:pl-[50px]">
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">Cookie: </span>
              ...
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">Company: </span>
                when this policy mentions “Company,” “we,” “us,” or “our,” it
                refers to Mploy.ing, Covent Garden, London that is responsible
                for your information under this Privacy Policy.
              </li>
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">Country: </span>
                where Mploy or the owners/founders of Mploy are based, in this
                case is United Kingdom
              </li>
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">Customer: </span>
                 refers to the company, organization or person that signs up to
                use the Mploy Service to manage the relationships with your
                consumers or service users.
              </li>
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">Device: </span>
                 any internet connected device such as a phone, tablet, computer
                or any other device that can be used to visit Mploy and use the
                services.
              </li>
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">IP address: </span>
              ...
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">Personnel: </span>
                refers to those individuals who are employed by Mploy or are
                under contract to perform a service on behalf of one of the
                parties.
              </li>
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
              ...
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">Service: </span>
                refers to the service provided by Mploy as described in the
              ...
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">Website: </span>
                Mploy's site, which can be accessed via this URL: mploy.ing
              </li>
              <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
                <span className="font-semibold text-[18px]">You: </span>a person
                or entity that is registered with Mploy to use the Services.
              </li>
            </ol>
            <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
          ...
          <ul className="pl-[20px] sm:pl-[50px]">
            <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
              Name / Username
            </li>
            <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
          ...
          <h3 className="text-[20px] leading-[30px] sm:text-[22px] sm:leading-[32px] xl:text-[24px] xl:leading-[36px] text-[#033777] font-[500] mt-[40px]">
            When does Mploy use end user information from third parties?
          </h3>
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            Mploy will collect End User Data necessary to provide the Mploy
          ...
          <h3 className="text-[20px] leading-[30px] sm:text-[22px] sm:leading-[32px] xl:text-[24px] xl:leading-[36px] text-[#033777] font-[500] mt-[40px]">
            When does Mploy use customer information from third parties?
          </h3>
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            interest in becoming a Mploy customer, we receive information from a
            third party that provides automated fraud detection services to
            Mploy. We also occasionally collect information that is made
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            Mploy will collect personal information that you submit to us. We
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            do. By submitting your email address, you also agree to allow us to
            use your email address for customer audience targeting on sites like
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            We keep your information only so long as we need it to provide Mploy
            to you and fulfill the purposes described in this policy. This is
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            information you transmit to Mploy or guarantee that your information
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            Mploy is incorporated in United Kingdom. Information collected via
            our website, through direct interactions with you, or from use of
          ...
          <h3 className="text-[20px] leading-[30px] sm:text-[22px] sm:leading-[32px] xl:text-[24px] xl:leading-[36px] text-[#033777] font-[500] mt-[40px]">
            Is the information collected through the Mploy Service secure?
          </h3>
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            information Mploy collects depend on your relationship with Mploy.
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            If you are a Mploy worker or applicant, we collect information you
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            all of the assets of Mploy or any of its Corporate Affiliates (as
            defined herein), or that portion of Mploy or any of its Corporate
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            control with Mploy, whether by ownership or otherwise. Any
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            this Privacy Policy except for those individuals who may have rights
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            shall govern this Agreement and your use of the website. Your use of
            the website may also be subject to other local, state, national, or
            international laws.
          </p>
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            By using Mploy or contacting us directly, you signify your
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            contain links to other websites not operated or controlled by Mploy.
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            Mploy uses "Cookies" to identify the areas of our website that you
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            You acknowledge and agree that Mploy shall not be responsible for
            any Third-Party Services, including their accuracy, completeness,
            timeliness, validity, copyright compliance, legality, decency,
            quality or any other aspect thereof. Mploy does not assume and shall
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            the right thing to do. At Mploy we strongly believe that your data
          ...
          <p className="text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
            ...
            rights requirements of GDPR. Mploy processes or stores all personal
          ...
          <ul className="pl-[20px] sm:pl-[50px]">
            <li className=" list-disc text-[16px] leading-[24px] text-[#161616] font-[400] mt-[16px]">
              Via Email:{" "}
              <a href="malito:info@mploy.com" className="text-primary">
                info@mploy.com
              </a>
            </li>
          </ul>
