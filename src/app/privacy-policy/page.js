    ...
    <div>
      ...
      <div className="widow-main bg-[#ffffff]  ">
        <div className="max-w-[1240px] mx-auto py-[100px] sm:py-[150px]">
          <h1 className="text-[48px] leading-[56px] xl:text-[60px] xl:leading-[64px] text-[#323d56]">
            Privacy Policy
          </h1>
          <h3 className="text-[20px] leading-[30px] sm:text-[22px] sm:leading-[32px] xl:text-[24px] xl:leading-[36px] text-[#161616] font-[500] mt-[40px]">
            Our privacy policy promise
          </h3>
          <p className="text-[16px] leading-[24px] text-[#2D2D2D] font-[400] mt-[16px]">
          ...
          <p className="text-[16px] leading-[24px] text-[#2D2D2D] font-[400] mt-[16px]">
            <p className="text-[16px] leading-[24px] text-[#2D2D2D] font-[400] ">
              We may collect, store and use the following kinds of personal
              information.
            </p>
            <ul className="pl-[20px]">
              <li className=" list-disc text-[16px] leading-[24px] text-[#2D2D2D] font-[400] mt-[16px]">
