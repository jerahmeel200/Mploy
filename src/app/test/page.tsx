...
function page() {
  return (
    <>
      <section className="section pt-28 pb-20" id="home">
        <div className="mx-10">
          ...
          <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div className="border w-full h-40 flex items-center justify-center">
              <a
                ...
                <span className="relative group-hover:text-white">Button</span>
              </a>
            </div>
            <div className="border w-full h-40 flex items-center justify-center">
              <a
            ...
            <div className="border w-full h-40 flex items-center justify-center">
              <a
                ...
                <span className="pl-4 pr-5 py-2.5">Button</span>
              </a>
            </div>
            <div className="border w-full h-40 flex items-center justify-center">
              <a
            ...
            <div className="border w-full h-40 flex items-center justify-center">
              <a
                href="#_"
                className="relative inline-block w-auto px-6 py-3 overflow-hidden text-base font-semibold text-center shadow text-gray-800 rounded-lg bg-gray-50 hover:text-black hover:bg-white">
                Button
              </a>
            </div>
            <div className="border w-full h-40 flex items-center justify-center">
